...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElementByXPath("( //div[@class = 'x-form-item x-tab-item']//input)[2]").sendKeys("TestName");
		driver.findElementByXPath("( //div[@class = 'x-form-item x-tab-item']//input)[3]").sendKeys("Testing");
		...
		if (confirmCompanyName.contains("NEWCOMPANY")) {
